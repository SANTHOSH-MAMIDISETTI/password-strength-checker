...
const HomePage = () => {
    ...
    console.log("it is ",result?.calcTime);
    console.log("c time",result?.crackTimesSeconds)
    console.log("time display",result?.crackTimesDisplay)
    console.log("feedback",result?.feedback)
    console.log("sugg",result?.feedback?.suggestions)
    console.log("war",result?.feedback?.warning)
